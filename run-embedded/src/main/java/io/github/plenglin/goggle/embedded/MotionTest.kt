...
fun main(args: Array<String>) {
    ...
    val acc = AccelerometerLSM303DLHC(i2c.getDevice(0x19), AccelerometerLSM303DLHCScale.S_8)
    val mag = MagnetometerLSM303DLHC(i2c.getDevice(0x1e), MagnetometerLSM303DLHCScale.S_81)
